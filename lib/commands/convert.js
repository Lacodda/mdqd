...
exports.command = 'convert <path> <targetPath> [recursive]';
exports.desc = 'Convert separate md-file or the entire directory containing md-files to html';
exports.builder = {
  path: {
    alias: 'p'
  },
...
exports.handler = async (argv) => {
  try {
    const results = await convert(argv.path, argv.targetPath);
